...
$wgConf->settings += [
	...
	'+wgFooterIcons' => [
		...
		'aceistanwiki' => [
			...
			'poweredby' => [
				'mediawiki' => [
					'src' => 'https://jbcstudios.miraheze.org/File:Poweredbymediawiki_badge.svg',
					'url' => 'https://www.mediawiki.org/',
					'alt' => 'Powered by MediaWiki',
				],
				'miraheze' => [
					'src' => 'https://jbcstudios.miraheze.org/File:Miraheze_badge.svg',
					'url' => 'https://meta.miraheze.org/wiki/Special:MyLanguage/Miraheze_Meta',
					'alt' => 'Hosted by Miraheze',
				],
			],
			'copyright' => [
				'copyright' => [
					'src' => 'https://jbcstudios.miraheze.org/File:Ccbysa_badge.svg',
